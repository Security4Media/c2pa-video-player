...
import cawg_anchors from '/trust/c2pa_anchors_extended.pem?url';
import cawg_store   from '/trust/cawg_store.cfg?url';
import cawg_allowed from '/trust/cawg_allowed_extended.pem?url';
import c2pa_allowed from '/trust/c2pa_allowed_extended.pem?url';
    ...
    const c2pa = await createC2pa({
      ...
      settings: {
        ...
        trust: {
          ...
          allowedList: [c2pa_allowed, 'https://raw.githubusercontent.com/contentauth/verify-site/refs/heads/main/static/trust/allowed.pem'],
          trustConfig: c2pa_store
        },
      },
    });
